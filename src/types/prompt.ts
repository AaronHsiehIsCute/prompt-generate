export interface PromptLeafOption { id: string; label: string; tokens: string[]; }
export interface PromptSubOption { id: string; label: string; tokens?: string[]; leaves?: PromptLeafOption[]; }
